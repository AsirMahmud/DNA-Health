...
exports.rxNavService = exports.RxNavService = exports.COMMON_RXNORM_CATALOG = void 0;
const env_js_1 = require("../config/env.js");
exports.COMMON_RXNORM_CATALOG = {
...
class RxNavService {
    cache = new Map();
    baseUrl = env_js_1.config.rxNavBaseUrl || "https://rxnav.nlm.nih.gov/REST";
    constructor() {
        // Prime cache with standard oncology drugs
        Object.values(exports.COMMON_RXNORM_CATALOG).forEach((concept) => {
    ...
    async searchDrugsByName(name) {
        ...
        return Object.values(exports.COMMON_RXNORM_CATALOG)
     ...
     */
    async getRelatedIngredients(rxcui) {
        try {
            const controller = new AbortController();
            const timeoutId = setTimeout(() => controller.abort(), 5000);
            const response = await fetch(`${this.baseUrl}/rxcui/${rxcui}/related.json?tty=IN+PIN`, {
                signal: controller.signal,
                headers: { Accept: "application/json" },
            });
            clearTimeout(timeoutId);
        ...
        const local = exports.COMMON_RXNORM_CATALOG[rxcui];
        return local ? [{ rxcui: local.rxcui, name: local.name }] : [];
    }
}
exports.RxNavService = RxNavService;
exports.rxNavService = new RxNavService();
