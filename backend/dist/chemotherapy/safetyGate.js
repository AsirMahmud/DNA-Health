...
exports.safetyGateEngine = exports.SafetyGateEngine = exports.DEFAULT_SAFETY_THRESHOLDS = void 0;
const loinc_js_1 = require("../terminology/loinc.js");
exports.DEFAULT_SAFETY_THRESHOLDS = {
    minANC: 1.5,
...
class SafetyGateEngine {
    ...
    constructor(thresholds = {}) {
        this.thresholds = { ...exports.DEFAULT_SAFETY_THRESHOLDS, ...thresholds };
    }
    /**
    ...
    evaluate(params) {
        ...
        let gateStatus = allRulesPassed ? "PASS" : "HOLD";
    ...
    evaluateANC(obs) {
        const loincCode = obs?.loincCode || loinc_js_1.LOINC_CODES.ANC_AUTOMATED;
        if (!obs) {
            return {
    ...
    evaluateCreatinine(obs) {
        const loincCode = obs?.loincCode || loinc_js_1.LOINC_CODES.CREATININE_SERUM_OR_PLASMA;
        if (!obs) {
            return {
